...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTHORINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUTHORINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTHORINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTHORINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTHORINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTHORINFO actions', async () => {
      const expectedActions = [
        {
