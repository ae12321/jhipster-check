...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).gender(DEFAULT_GENDER);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).gender(UPDATED_GENDER);
        return author;
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).gender(UPDATED_GENDER);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.gender(UPDATED_GENDER);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).gender(UPDATED_GENDER);
