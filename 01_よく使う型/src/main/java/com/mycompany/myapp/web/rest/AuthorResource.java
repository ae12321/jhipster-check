...
public class AuthorResource {
    ...
    public ResponseEntity<Author> partialUpdateAuthor(
        ...
        Optional<Author> result = authorRepository
            ...
            .map(existingAuthor -> {
                if (author.getColA() != null) {
                    existingAuthor.setColA(author.getColA());
                }
                if (author.getColB() != null) {
                    existingAuthor.setColB(author.getColB());
                }
                if (author.getColC() != null) {
                    existingAuthor.setColC(author.getColC());
                }
                if (author.getColD() != null) {
                    existingAuthor.setColD(author.getColD());
                }
                if (author.getColE() != null) {
                    existingAuthor.setColE(author.getColE());
                }
                if (author.getColF() != null) {
                    existingAuthor.setColF(author.getColF());
                }
