...
export const StudentUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...studentEntity,
          skills: studentEntity?.skills?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myappApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            Studentを追加または編集
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Skill" id="student-skill" data-cy="skill" type="select" multiple name="skills">
                <option value="" key="0" />
                {skills
