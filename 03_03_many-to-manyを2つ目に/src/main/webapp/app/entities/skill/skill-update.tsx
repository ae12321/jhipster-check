...
export const SkillUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...skillEntity,
          students: skillEntity?.students?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myappApp.skill.home.createOrEditLabel" data-cy="SkillCreateUpdateHeading">
            Skillを追加または編集
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Type" id="skill-type" name="type" data-cy="type" type="text" />
              <ValidatedField label="Student" id="skill-student" data-cy="student" type="select" multiple name="students">
                <option value="" key="0" />
                {students
